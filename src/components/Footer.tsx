          ...
          <div className="flex flex-col items-center md:items-start space-y-4 w-full">
            ...
            <div className="grid grid-cols-2 gap-3 w-full">
              {contactInfo.map((info, index) => (
                <>
                  <span key={`label-${index}`} className="text-sm text-gray-500 text-left break-words">
                    {info.label}:
                  </span>
                  <a
                    key={`value-${index}`}
                    ...
                    className="flex items-center gap-2 text-gray-600 hover:text-primary transition-colors text-sm sm:text-base text-left break-words"
                  >
                    {info.icon}
